...
# ╔═╡ 8ad1738b-c757-4528-96dc-d57a8f5f5305
size(ImageToCarve)
...
# ╔═╡ 132374b5-2c45-4c75-91df-86797f64a759
seam1 = FindSeam_Y(edges(wave))

# ╔═╡ aa31a689-ad06-4e47-a4e1-d67177d6f642
wav = RemoveSeam_Y(wave, seam1)

# ╔═╡ 2fc15c5f-55fd-404d-a462-919bcc71d90f
seam2 = FindSeam_Y(edges(wav))

# ╔═╡ ca71c89e-7dac-49ab-867c-17acac0438b8
wa = RemoveSeam_Y(wave, seam2)

# ╔═╡ 8154e276-3258-4ec4-aca1-1b73f3c3c4e6
function SeamOrder_Y(energy, n)
	order = []#[zeros(Int, n)]
	leastE_map, directions = LeastEnergyMap_Y(energy)
...
SeamOrder_Y(edges(wave),1700-size(wave)[2])[1]
...
function SeamAdding_Y(img, width)
	...
	energy = edges(img)
	n = width - img_width
	seams, directions = SeamOrder_Y(energy, n)
	
	for i in 1:n
		seam = FindSeamAt_Y(directions, seams[i])
